...
forktest(void)
{
  ...
  3c:	44850513          	addi	a0,a0,1096 # 480 <pgaccess+0xa>
  ...
  66:	46e50513          	addi	a0,a0,1134 # 4d0 <pgaccess+0x5a>
  ...
  88:	40c50513          	addi	a0,a0,1036 # 490 <pgaccess+0x1a>
  ...
  a2:	40a50513          	addi	a0,a0,1034 # 4a8 <pgaccess+0x32>
  ...
  e2:	3e250513          	addi	a0,a0,994 # 4c0 <pgaccess+0x4a>
...
gets(char *buf, int max)
{
 ...
 224:	1c6080e7          	jalr	454(ra) # 3e6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28c:	19e080e7          	jalr	414(ra) # 426 <fstat>
 290:	892a                	mv	s2,a0
  close(fd);
 292:	8526                	mv	a0,s1
 294:	00000097          	auipc	ra,0x0
 298:	162080e7          	jalr	354(ra) # 3f6 <close>
  return r;
 29c:	64a2                	ld	s1,8(sp)
}
 29e:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 3b8:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff30e>
